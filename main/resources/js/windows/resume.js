function resumeWindow() {
    ...
    minimizeX.setAttribute("onclick", `document.getElementById(${randMarkableId}).style.width = "auto"; document.getElementById(${randMarkableId}).style.height = "auto"`)
    ...
    resWindowBodyP.style = "width: auto; height: auto;"
